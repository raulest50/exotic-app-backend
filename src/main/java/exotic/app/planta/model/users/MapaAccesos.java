...
public final class MapaAccesos {
    ...
    static {
        ...
        TABS_POR_MODULO.put(ModuloSistema.PRODUCCION, Set.of("CREAR_ODP_MANUALMENTE", "HISTORIAL", "PARAMETROS_POR_CATEGORIA", "PLANEACION_PRODUCCION", "SEGUIMIENTO_AREAS_OPERATIVAS"));
