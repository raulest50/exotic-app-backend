...
public final class MapaAccesos {
    ...
    static {
        ...
        TABS_POR_MODULO.put(
                ...
                Set.of("INFORMES_DIARIOS", "INFORMES_GLOBALES", "SERIES_TIEMPO_PROYECCIONES", "APROVISIONAMIENTO", "PERSONAL")
        );
        ...
        TABS_POR_MODULO.put(ModuloSistema.ADMINISTRACION_GLOBAL, Set.of("IDENTIDAD_LEGAL", "JORNADA_LABORAL"));
        ...
        TABS_POR_MODULO.put(ModuloSistema.TRANSACCIONES_ALMACEN, Set.of("INGRESO_OCM", "HACER_DISPENSACION", "DISPENSACION_V2", "HISTORIAL_DISPENSACIONES", "INGRESO_PRODUCTO_TERMINADO", "GESTION_AVERIAS", "AJUSTES_INVENTARIO"));
