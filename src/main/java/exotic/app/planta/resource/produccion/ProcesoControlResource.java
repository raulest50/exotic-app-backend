...
public class ProcesoControlResource {
    ...
    public Page<PlanResumenResponse> resumenPlanes(
        ...
        requirePlan(auth, 1);
        return planService.listarResumenes(AmbitoControl.PROCESO, search, estado, page, size);
    }
    ...
    public PlanVersionDetalleResponse detalleVersion(
        ...
        requirePlan(auth, 1);
        return planService.detalleVersion(AmbitoControl.PROCESO, planId, versionId);
    }
